...
### Project Structure
```
├── shivangdave123_s_application25.xcodeproj  - it lets you create and modify Xcode projects from Ruby.      
│ 
├── shivangdave123_s_application25            - Application components folder
