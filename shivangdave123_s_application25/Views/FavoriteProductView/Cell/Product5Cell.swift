    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack {
                            ...
                            Text(StringConstants.kLbl24Off)
                                ...
                                .minimumScaleFactor(0.5)
                                .multilineTextAlignment(.leading)
                                .frame(width: getRelativeWidth(size: 49.0), height: getRelativeHeight(size: 15.0), alignment: .leading)
                                .padding(.leading, getRelativeWidth(size: 8.0))
                        }
                        .frame(width: getRelativeWidth(size: 99.0), height: getRelativeHeight(size: 15.0), alignment: .leading)
                        .padding(.top, getRelativeHeight(size: 4.0))
                    }
                    .frame(width: getRelativeWidth(size: 99.0), height: getRelativeHeight(size: 41.0), alignment: .leading)
                    Spacer()
                    Image("img_trashicon")
                        .resizable()
                ...
                .frame(width: getRelativeWidth(size: 131.0), height: getRelativeHeight(size: 41.0), alignment: .leading)
                .padding(.top, getRelativeHeight(size: 16.0))
            }
