        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack {
                ...
                Text(StringConstants.kLbl24Off)
                    ...
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.leading)
                    .frame(width: getRelativeWidth(size: 44.0), height: getRelativeHeight(size: 15.0), alignment: .leading)
                    .padding(.leading, getRelativeWidth(size: 8.0))
            }
            .onTapGesture {}
            .frame(width: getRelativeWidth(size: 94.0), height: getRelativeHeight(size: 15.0), alignment: .leading)
